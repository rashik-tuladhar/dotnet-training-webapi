...
{
    [SecurityAuthentication("BookController")]
    [ApiVersion("2.0")]
    [ApiController]
    [Route("api/v{version:apiVersion}/book")]
    //[Authorize(Roles = "SuperAdmin")]
    public class BookV2Controller : Controller
    {
        ...
        public BookV2Controller(IBookBusiness bookBusiness, IWebHostEnvironment webHostEnvironment)// IAuthorBusiness authorBusiness, ICategoryBusiness categoryBusiness, IPublicationBusiness publicationBusiness, IWebHostEnvironment webHostEnvironment)
        {
